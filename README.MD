...
- Groovy DSL
    ...
    ```groovy
    implementation 'com.github.qlsolutions.JavalinFly:javalinfly-core:0.1.8b13'
    ```

    - Annotation processor

    ```groovy
    annotationProcessor 'com.github.qlsolutions.JavalinFly:javalinfly-core:0.1.8b13'
    ```
    ...
    - <details>
        ...
        ```groovy
        implementation 'com.github.qlsolutions.JavalinFly:javalinfly-kotlin:0.1.8b13'
        ```
